        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              ...
              <ul>
                <li><strong>Category</strong>: Apps</li>
                <li><strong>Client</strong>: - </li>
                <li><strong>Project date</strong>: 15 April, 2023</li>
                <li><strong>Project URL</strong>: <a href="#">https://www.figma.com/design/xuLNIUkj5jmp6cODCIDX7L/IMK_Papikos?node-id=0-1</a></li>
              </ul>
            </div>
            <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300">
              <h2>Papikos, A User-Friendly Flat-Apps</h2>
              <p>
              Papikos is a user-friendly mobile application designed to streamline the process of finding and renting apartments or flats, specifically tailored for college students. With a simple and intuitive interface, Papikos allows students to browse a wide range of rental options, compare prices, view detailed property information, and book their accommodations directly through the app. Its goal is to make the search for student housing convenient, efficient, and stress-free.
              </p>
            </div>
          </div>
...
</html><?php /**PATH D:\Softwares\xampp\htdocs\testAppJipi\resources\views/portfolio2.blade.php ENDPATH**/ ?>